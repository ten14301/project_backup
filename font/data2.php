<?php
	...
	$result1 = $conn->query("SELECT * FROM dtmoisensor10, hour1data;");
	echo "<h1  style='text-align:center;color: white;'>ข้อมูล sensor ความชื้นตัวที่ 1 1 ชั่วโมงที่แล้ว</h1>";
	...
	$result2 = $conn->query("SELECT * FROM dtmoisensor10, hour1datab;");
	
	echo "<h1  style='text-align:center;color: white;'>ข้อมูล sensor ความชื้นตัวที่ 2 1 ชั่วโมงที่แล้ว</h1>";
	echo "<table border='2' align=center style='background-color:white'><tr>
	...
	$result3 = $conn->query("SELECT * FROM dtmoisensor10, hour1datac;");
	echo "<h1  style='text-align:center;color: white;'>ข้อมูล sensor วัดปุ๋ย  1 ชั่วโมงที่แล้ว</h1>";
	echo "<table border='2' align=center style='background-color:white'><tr>
	<th style='background-color:white'>วันและเวลา</th>
	<th style='background-color:white'>ข้อมูล</th>
	</tr>";
